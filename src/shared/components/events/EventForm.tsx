                ...
                <div className="flex items-center gap-4">
                  ...
                  {imagePreview && (
                    <div className="relative">
                      ...
                      <button type="button" onClick={handleRemoveImage} className="absolute -right-2 -top-2 flex h-6 w-6 items-center justify-center rounded-full bg-red-600 text-white hover:bg-red-700">
                        <X className="h-4 w-4" />
                      </button>
                    </div>
                  )}
